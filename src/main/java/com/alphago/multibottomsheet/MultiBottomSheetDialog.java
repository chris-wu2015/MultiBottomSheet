 ...
 */
public class MultiBottomSheetDialog extends AppCompatDialog {

    private MultiBottomSheetBehavior<FrameLayout> mBehavior;

    boolean mCancelable = true;
    private boolean mCanceledOnTouchOutside = true;
    private boolean mCanceledOnTouchOutsideSet;

    public MultiBottomSheetDialog(@NonNull Context context) {
        this(context, 0);
    }

    public MultiBottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    protected MultiBottomSheetDialog(@NonNull Context context, boolean cancelable,
    ...
    private MultiBottomSheetBehavior.BottomSheetCallback mBottomSheetCallback
