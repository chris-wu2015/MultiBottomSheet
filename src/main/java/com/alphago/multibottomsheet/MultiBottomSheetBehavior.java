 ...
 * a bottom sheet.
 */
public class MultiBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    List<WeakReference<View>> mNestedScrollingChildren;
     ...
     */
    public MultiBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, V child, int layoutDirection) {
        ...
        mNestedScrollingChildren = findScrollingChildren(child);
        return true;
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, V child, MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                for (WeakReference<View> weakReference : mNestedScrollingChildren) {
                    View scroll = weakReference.get();
                    if (scroll != null && parent.isPointInChildBounds(scroll, initialX, mInitialY)) {
                        mNestedScrollingChildRef = weakReference;
    ...
    private List<WeakReference<View>> findScrollingChildren(View view) {
        List<WeakReference<View>> children = new ArrayList<>();
        if (view instanceof NestedScrollingChild && ((NestedScrollingChild) view).isNestedScrollingEnabled()) {
            children.add(new WeakReference<View>(view));
        }
        if (view instanceof ViewGroup) {
            ViewGroup group = (ViewGroup) view;
            for (int i = 0, count = group.getChildCount(); i < count; i++) {
                List<WeakReference<View>> scrollingChildren = findScrollingChildren(group.getChildAt(i));
                children.addAll(scrollingChildren);
            }
        }
        return children;
    }
    ...
    /**
     * A utility function to get the {@link MultiBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link MultiBottomSheetBehavior}.
     * @return The {@link MultiBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> MultiBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof MultiBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with MultiBottomSheetBehavior");
        }
        return (MultiBottomSheetBehavior<V>) behavior;
    }
